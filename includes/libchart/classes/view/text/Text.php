<?php
	...
	class Text {
		...
		public function Text() {
			...
			$this->fontCondensed = $baseDir . "../includes/libchart/fonts/DejaVuSansCondensed.ttf";
			$this->fontCondensedBold = $baseDir . "../includes/libchart/fonts/DejaVuSansCondensed-Bold.ttf";
		}
