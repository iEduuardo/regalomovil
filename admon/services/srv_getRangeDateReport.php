                  ...
                  <tr>
                    ...
                    <td valign="top" class="report_title_form">
                    	 <label for="date2">Fecha final:</label>
							<select class="selects_reports" name="fecha_2_dia" id="fecha_2_dia">
                            	<?php
									for($x=1;$x<=31;$x++){
											if($x <=9){
												 $valor = "0".$x;
                            ...
                            <select class="selects_reports" name="fecha_2_mes" id="fecha_2_mes">
                            	<option<?php if(date('n') == 1){echo " SELECTED";}?> value="Jan">Enero</option>
								<option<?php if(date('n') == 2){echo " SELECTED";}?>  value="FEB">Febrero</option>
                                <option<?php if(date('n') == 3){echo " SELECTED";}?>  value="MAR">Marzo</option>
                                <option<?php if(date('n') == 4){echo " SELECTED";}?>  value="APR">Abril</option>
                            ...
                            <select class="selects_reports" name="fecha_2_ano" id="fecha_2_ano">
                            	<?php
									for($x=2010;$x<=date('Y');$x++){
											if($x <=9){
												 $valor = "0".$x;
                    ...
                    <td valign="top" class="reports_espaciador_forms">|</td>
                    <td valign="top"><input type="button" name="fecha_1_action" id="fecha_1_action" value="Generar"  onclick="javascript:getReporte(2);"/></td>
                  </tr>
                </table>      
                    </td>
                  </tr>
