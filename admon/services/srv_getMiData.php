...
?>
 <form id="newUserForm" name="newUserForm" method="GET" action="newUser.pgp">
           			<table width="100%">
                        ...
                        <tr><td colspan="4" align="right"><a class="btn_operacion" href="#" onclick="javascript:editThisUser();">Editar mis datos</a> </td></tr>
                            ...
                            <td valign="top">
                                   <table width="100%" border="0" cellpadding="0" cellspacing="2" align="center">
                                        ...
                                        <td class="titleItem">Tipo de usuario: </td>
                                         ...
                                         <?php echo getListaTiposUsuario('int_tipodeusuario', $_verifierInput, $datos[11]);?>
                                         </td>
                                        </tr>
                                        ...
                                        <tr><td class="titleItem">PDV: </td><td class="textItem" id="nombrePDV"><?php echo getListaPDVsUser($datos[2],$datos[3],$datos[4]) ;?></td></tr>
