...
if($_GET['id'] && $_GET['do']==1){
			$_idusuario = $_GET['id'];
			$sql = "SELECT id_usuario, id_merchant, id_sucursal, id_pos, id_terminal, str_username, str_password, str_nombre, str_apellidoP, dt_fechadecreacion, str_email, int_tipodeusuario FROM  "._PREPOS."tbl_usuarios WHERE  id_usuario =".$_idusuario;
			$rs = getRecordSet($sql);
           ...
           <form id="newUserForm" name="newUserForm" method="GET" action="newUser.pgp">
           			<table width="100%">
                    	...
                    	<tr>
                            ...
                            <td valign="top">
                                   <table width="100%" border="0" cellpadding="0" cellspacing="2" align="center">
                                        <tr><td class="titleItem" width="150">Merchant: </td><td class="textItem"><?php echo getListaMerchantsUser("id_merchant", true, $datos[1]);?></td></tr>                                 
                                        <tr><td colspan="2" class="espaciadorSinColor"></td></tr>
                                        <tr>
                                        <td class="titleItem">Tipo de usuario: </td>
                                         <td class="textItem" id="listadoDeTiposUsuarios">
                                         <?php echo getListaTiposUsuario('int_tipodeusuario', true, $datos[11]);?>
                                         </td>
                                        </tr>
                                        <tr><td class="titleItem">Sucursal: </td><td class="textItem" id="listadoDeMerchants"><?php echo getListaSucursalesUser($datos[1],$datos[2]);?></td></tr>
                                        <tr><td class="titleItem">PDV: </td><td class="textItem" id="nombrePDV"><?php echo getListaPDVsUser($datos[1],$datos[2],$datos[3]);?></td></tr>
